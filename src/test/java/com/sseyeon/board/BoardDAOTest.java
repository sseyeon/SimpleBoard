...
public class BoardDAOTest {
	...
	public void testInsertBoard() throws Exception{
		...
		boardVO.setTitle("첫번째 게시물 제목 입니다.");
		boardVO.setContent("첫번째 게시물 내용 입니다.");
		boardVO.setTag("1");
		boardVO.setReg_id("1");
	...
	public void testUpdateBoard() throws Exception{
		BoardVO boardVO = new BoardVO();
		boardVO.setCate_cd("1");
		boardVO.setTitle("첫번째 게시물 제목 입니다. - 수정");
		boardVO.setContent("첫번째 게시물 내용 입니다. - 수정");
		boardVO.setTag("1-1");
